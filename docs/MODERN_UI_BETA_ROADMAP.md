...
Release candidate: `v9.2.0-beta.13` or newer.
...
Do not wire real flashing into the Wizard until these are true:
...
6. CI validates the Wizard model and state adapter before packaging.
...
## Phase 2: Dashboard usefulness

Goal: make the compact Dashboard valuable without replacing the legacy UI yet.
