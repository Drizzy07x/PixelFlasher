...
packaged smokes stay open. The Tools page now owns the bounded logcat viewer, scrcpy,
...
| Applications | Play Store ownership and packaged cross-platform smokes remain; listing, install, verified export, denylist, SU and the other package actions are connected to React. |
