...
| G34 | `app.preferences_shell` (`partial`, tipografía de consola entregada el 20-07-2026) | G32 | Completar layout de toolbar, carpetas, consola redacted y exit; el host abre carpetas/enlaces y controla lifecycle. La tipografía de superficies monoespaciadas ya se aplica sin reiniciar. | Reinicio/persistencia, rutas inexistentes, consola sin secretos, cierre con operación activa y smokes de chrome nativo. |
