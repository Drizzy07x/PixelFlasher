...
Este documento convierte los 33 gates de publicación todavía abiertos de
...
renumerar las dependencias históricas; no forman parte de los 33 gates abiertos.
...
| Gates cerrados | 19 (36,5 %) | Ya están en `native`; siguen sujetos a regresión empaquetada. |
| Gates abiertos | 33 (63,5 %) | Los 33 están `partial`; ya no queda ningún gate `blocked`. |
...
| Plataformas afectadas por cada gate abierto | 33 de 33 en las tres | Windows, macOS y Linux deben presentar la misma capacidad. |
...
Distribución de los 33 gates abiertos por riesgo:
...
Esta wave no agrega gates de paridad: demuestra que los 33 gates restantes, una vez cerrados, son
