...
| Comandos expuestos e implementados | 56 (78,9 %) | No puede quedar ningún comando `not_implemented` en el artefacto final. |
| Comandos registrados no expuestos | 15 | Implementarlos o retirarlos mediante una decisión de contrato revisada antes de RC1. |
...
Los 15 comandos todavía no expuestos son: `backups.delete`, `backups.list`,
...
| G39 | `dev.tools` (`partial`, flujo AVB downgrade nativo entregado el 19-07-2026) | `native.file_dialogs` | Implementar keybox validation y XML binario como servicios separados, con entradas acotadas y salidas tipadas; cerrar smokes AVB empaquetados/hardware. | Ya hay pruebas de SPL, fingerprint, hash, cancelación, postcondición, AVB bundle real, grants opacos, bridge cerrado y UI React. Faltan fuzz de XML/keybox/imágenes, los dos servicios restantes y validación empaquetada; ninguna ejecución shell implícita está autorizada. |
