...
| G19 | `flash.execute` (`partial`, runner principal conectado el 19-07-2026) | G11, G14–G18 | Entregado: `OperationPlan` y `OperationBatch` se revalidan, ejecutan secuencialmente y fallan rápido para factory/custom/OTA; OTA y fastbootd tienen transiciones backend y observers de build/slot/hash. Pendiente: producir evidencia persistida de factory stock completa para relock, E2E WebView y hardware empaquetado. | La matriz fake cubre success/cancel/failed/unknown, serial/revisión/hash/mode mismatch, batches y transiciones; faltan evidencia de relock, hardware y E2E empaquetado. |
