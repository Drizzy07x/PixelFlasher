...
| Comandos expuestos e implementados | 60 (84,5 %) | No puede quedar ningún comando `not_implemented` en el artefacto final. |
| Comandos registrados no expuestos | 11 | Implementarlos o retirarlos mediante una decisión de contrato revisada antes de RC1. |
...
Los 11 comandos todavía no expuestos son: `firmware.catalog.refresh`,
`firmware.pick`, `firmware.pickCustomRom`,
`tools.adbShell`, `tools.dataAdb`, `tools.myTools`,
