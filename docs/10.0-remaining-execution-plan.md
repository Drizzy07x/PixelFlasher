...
Este documento convierte los 32 gates de publicación todavía abiertos de
...
renumerar las dependencias históricas; no forman parte de los 32 gates abiertos.
...
| Gates cerrados | 20 (38,5 %) | Ya están en `native`; siguen sujetos a regresión empaquetada. |
| Gates abiertos | 32 (61,5 %) | Los 32 están `partial`; ya no queda ningún gate `blocked`. |
...
| Gates abiertos con alguna prueba citada | 32 | La referencia existente caracteriza solo el subconjunto actual; no implica que el gate esté cerrado. |
| Gates abiertos sin prueba citada | 0 | Se mantiene en cero al añadir capacidades o subdividir gates. |
| Plataformas afectadas por cada gate abierto | 32 de 32 en las tres | Windows, macOS y Linux deben presentar la misma capacidad. |
...
Distribución de los 32 gates abiertos por riesgo:
...
Esta wave no agrega gates de paridad: demuestra que los 32 gates restantes, una vez cerrados, son
