...
| Comandos expuestos e implementados | 58 (81,7 %) | No puede quedar ningún comando `not_implemented` en el artefacto final. |
| Comandos registrados no expuestos | 13 | Implementarlos o retirarlos mediante una decisión de contrato revisada antes de RC1. |
...
Los 13 comandos todavía no expuestos son: `backups.delete`, `backups.list`,
